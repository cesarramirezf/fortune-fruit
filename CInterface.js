function CInterface() {
  ...
  this._init = function () {
    ...
    _oButPaytable = new CGfxButton(
      _pStartPosPaytable.x,
      _pStartPosPaytable.y,
      oSpriteCredits,
      s_oStage
    );
  ...
  this.refreshButtonPos = function () {
    ...
    _oButPaytable.setPosition(
      _pStartPosPaytable.x + s_iOffsetX,
      _pStartPosPaytable.y + s_iOffsetY
    );
  };
  ...
  this._onExitFromHelp = function (bExit) {
    if (_aCbCompleted[ON_EXIT_FROM_HELP]) {
      _aCbCompleted[ON_EXIT_FROM_HELP].call(
        _aCbOwner[ON_EXIT_FROM_HELP],
        bExit
      );
    }
  };
