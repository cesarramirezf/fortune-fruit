function CTopGUI(iWinnings, iCurCard, iNumCards, oParentContainer) {
  ...
  this.refreshButtonPos = function () {
    ...
    _oContainerWinnings.x =
      GRID_POS.x - LOGIC_CELL_WIDTH * CUR_GRID_SCALE * 1.5;
    _oContainerWinnings.y =
      GRID_POS.y - LOGIC_CELL_HEIGHT * CUR_GRID_SCALE * 1.5 - 50;
